...
const tableData = [16,20,24,30,36,42,48];

const TwoPhaseHorizontalSolution:React.FC<Props>  = ({inputData}) => {
    ...
    const dGasLeff = Calculation.dGasLeff(inputData.formInputs.To, inputData.formInputs.ZFactor, inputData.formInputs.Qg, 
        inputData.formInputs.Po, pg as number, pl as number, CD4 as number, inputData.formInputs.dm);

    const d2LiquidLeff1 = Calculation.d2LiquidLeff1(inputData.formInputs.tr, Ql as number);
    ...
    const latex2_2 = `$$d*L_{eff}=420*[\\frac{${inputData.formInputs.To}*${inputData.formInputs.ZFactor}*${inputData.formInputs.Qg}}{${inputData.formInputs.Po}}]*[(\\frac{${pg}}{${pl}-${pg}})*\\frac{${CD4}}{${inputData.formInputs.dm}}]^{1/2}$$`;
    ...
    return(
        <>
            ...
            <div className="mb-8 p-4 bg-gray-50 border border-gray-400 rounded-lg shadow-md max-w-full mx-auto">
                <div className="flex flex-col justify-center items-center">
                    <div className='mb-4'>
            ...
            <table className="min-w-full bg-gray-50 border border-gray-400 text-center rounded-lg max-w-full shadow-md">
                ...
                <tbody>
                    {rows.map(({ d, gasLeff, liquidLeff, Lss, SR }, index) => {
                        const isHighlighted = (SR as number  >=2 && SR as number <= 5);
